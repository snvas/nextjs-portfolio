	...
	return <div className="pt-[8rem] pb-[4rem] bg-[#02050a]">
		...
		<div className="flex items-center space-x-4">
			...
			<div>
				...
				<p className="text-[17px] w-[100%] text-white opacity-60">+55 44 99924-7466 <br /> +55 11 94006-2075</p>
			</div>
		</div>
		<div className="flex items-center space-x-4">
			<div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]">
			...
			<div>
				...
				<p className="text-[17px] w-[90%] text-white opacity-60"><a href="mailto:contato@soraianovaes.com.br">contato@soraianovaes.com.br</a></p>
			</div>
		</div>
		</div>
